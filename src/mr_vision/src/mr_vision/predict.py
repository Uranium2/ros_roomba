...
PROJECT_FOLDER = "/home/uranium/Documents/Cours/robotics_courses/src/mr_vision/src/mr_vision"

# Path to frozen detection graph. This is the actual model that is used for the object detection.
PATH_TO_CKPT = os.path.join(PROJECT_FOLDER, "fine_tuned_model/frozen_inference_graph.pb")


# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(PROJECT_FOLDER, "fine_tuned_model/label_map.pbtxt")
